...
export function getPageSeo(pathname: string): PageSeo {
  ...
  return {
    ...
    type: article ? "article" : "website", image: SOCIAL_IMAGE,
    imageAlt: "Armature AI Labs — The Physical AI and Robotics Lab, HSR Layout, Bengaluru",
...
export function renderSeoHead(page: PageSeo): string {
  ...
  return [
    ...
    meta("property", "og:image", page.image), meta("property", "og:image:width", "1200"),
    meta("property", "og:image:height", "627"), meta("property", "og:image:alt", page.imageAlt),
