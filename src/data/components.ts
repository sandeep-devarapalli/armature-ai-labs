...
export const components: CatalogComponent[] = [
  {
    ...
    description: "Raspberry Pi Pico W, headers, wiring, and MicroPython firmware for the documented wake, sample, HTTPS upload, and deep-sleep loop.",
    inventoryClass: "reusable_tray",
    availability: "unavailable",
    validationState: "source_required",
    quantityTarget: 6,
    quantityUnit: "controller kits",
    tags: ["DIY Weather Station", "Raspberry Pi Pico W", "MicroPython", "Wi-Fi", "deep sleep"],
    validationNotes: ["Verify the current upstream pin map and firmware revision against the selected sensors before assembly.", "Keep API keys out of the repository and require HTTPS, a five-minute sample cycle, reconnect handling, and measured sleep-current evidence before outdoor deployment."]
  },
  {
    slug: "weather-environment-sensor-set",
    name: "DIY Weather Station sensor set",
    category: "Environmental sensing",
    description: "DHT22 temperature and humidity sensor, BMP180 barometer, anemometer, light sensor, rain sensor, and weather-resistant cabling for one station.",
    inventoryClass: "reusable_tray",
    availability: "unavailable",
    validationState: "source_required",
    quantityTarget: 6,
    quantityUnit: "sensor sets",
    tags: ["DIY Weather Station", "DHT22", "BMP180", "anemometer", "rain sensor", "light sensor"],
    validationNotes: ["Confirm the exact anemometer interface and rain-sensor construction against the latest repository files before PO.", "Bench-compare temperature, humidity, pressure, wind, light, and rain readings with reference instruments, then document offsets and maintenance intervals."]
  },
  {
    slug: "weather-solar-power-stack",
    name: "DIY Weather Station solar power stack",
    category: "Power and safety",
    description: "Solar panel, two protected 18650 cells, compatible charge and regulation hardware, fused wiring, battery holder, and Pico VSYS voltage monitoring for one outdoor node.",
    inventoryClass: "reusable_tray",
    availability: "unavailable",
    validationState: "source_required",
    quantityTarget: 6,
    quantityUnit: "power stacks",
    tags: ["DIY Weather Station", "solar", "18650", "battery monitoring", "outdoor power"],
    validationNotes: ["The repository schematic shows a solar-charged two-cell supply but does not identify every power-board part number; approve an exact protected-cell, charger, and regulator combination before PO.", "Run charge, low-light endurance, reverse-polarity, temperature, enclosure, and safe-fault tests before unattended operation."]
  },
  {
    slug: "weather-outdoor-enclosure-set",
    name: "DIY Weather Station outdoor enclosure set",
    category: "Fabrication",
    description: "Published printable station body, case, lid, anemometer and rain-sensor parts, mast hardware, seals, cable glands, and UV-resistant PETG or ASA filament.",
    inventoryClass: "reusable_tray",
    availability: "unavailable",
    validationState: "source_required",
    quantityTarget: 6,
    quantityUnit: "enclosure sets",
    tags: ["DIY Weather Station", "3D printing", "PETG", "ASA", "weatherproofing"],
    validationNotes: ["Use the current upstream models and record slicer settings, material, hardware, and any dimensional changes.", "Validate drainage, sensor exposure, UV and rain resistance, mast retention, service access, and cable strain relief before installation."]
  },
  {
    slug: "weather-dashboard-server",
    name: "DIY Weather Station dashboard server",
    category: "Compute and storage",
    description: "Docker host and deployment configuration for the documented Flask API, MariaDB datastore, Nginx proxy, and responsive 24-hour weather dashboard.",
    inventoryClass: "fixed_equipment",
    availability: "unavailable",
    validationState: "source_required",
    quantityTarget: 1,
    quantityUnit: "shared deployments",
    tags: ["DIY Weather Station", "Flask", "MariaDB", "Docker", "Nginx", "HTTPS"],
    validationNotes: ["Deploy from pinned images with secrets outside source control, TLS, database backups, health checks, and bounded retention.", "Verify API authentication, replay and rate-limit behavior, schema migration, restore, and an offline sensor retry path before accepting field data."]
  },
  {
    slug: "indymill-motion-structure-set",
    name: "IndyMill motion and structure set",
    category: "Fabrication",
    description: "2040 and 2080 aluminum profiles, MGN12 rails and blocks, SFU1605 ballscrews, Z lead screw, laser-cut 6 mm and 8 mm plates, bearings, couplers, belts, pulleys, printed holders, and assembly hardware for one machine.",
    inventoryClass: "fixed_equipment",
    availability: "unavailable",
    validationState: "source_required",
    quantityTarget: 1,
    quantityUnit: "machine sets",
    tags: ["IndyMill", "MGN12", "SFU1605", "aluminum extrusion", "laser-cut plates", "CNC"],
    validationNotes: ["Reconcile the latest upstream BOM, drawings, plate thicknesses, rail lengths, screw machining, bearing fits, and fastener grades before fabrication.", "Measure frame squareness, rail parallelism, backlash, travel, runout, and repeatability before mounting a cutting tool."]
  },
  {
    slug: "indymill-grbl-motion-control-set",
    name: "IndyMill GRBL motion-control set",
    category: "Motion",
    description: "Four NEMA 23 stepper motors, four DM542 drivers, Arduino Uno, IndyShield GRBL interface, 36 V 16.6 A supply, shielded wiring, connectors, and control enclosure for the published four-axis electronics stack.",
    inventoryClass: "fixed_equipment",
    availability: "unavailable",
    validationState: "source_required",
    quantityTarget: 1,
    quantityUnit: "control sets",
    tags: ["IndyMill", "NEMA 23", "DM542", "Arduino Uno", "IndyShield", "GRBL"],
    validationNotes: ["Confirm current IndyShield files, the exact Arduino Uno compatibility, motor current, driver settings, supply margin, grounding, shielding, connector ratings, and enclosure cooling before PO.", "Commission one axis at a time with conservative limits, direction checks, travel calibration, homing, and emergency-stop verification."]
  },
  {
    slug: "indymill-500w-spindle-power-set",
    name: "IndyMill 500 W spindle and power set",
    category: "Fabrication",
    description: "Baseline 500 W spindle, matched speed controller, mount, collets, shielded cabling, mains inlet, isolation, and earthing hardware for the documented starter configuration.",
    inventoryClass: "fixed_equipment",
    availability: "unavailable",
    validationState: "source_required",
    quantityTarget: 1,
    quantityUnit: "spindle sets",
    tags: ["IndyMill", "500 W spindle", "collets", "mains power", "machining"],
    validationNotes: ["Verify spindle voltage, controller, mount diameter, collet system, speed control, runout, duty cycle, earthing, and India mains compliance as one matched set.", "Complete electrical inspection and no-load, runout, vibration, thermal, and emergency-stop tests before cutting material."]
  },
  {
    slug: "indymill-machine-safety-set",
    name: "IndyMill machine safety set",
    category: "Power and safety",
    description: "Hardwired emergency stop, limit switches, Z probe, guarded electronics, chip and spindle enclosure, dust or chip extraction, task lighting, signage, and supervised-use PPE for one CNC cell.",
    inventoryClass: "fixed_equipment",
    availability: "unavailable",
    validationState: "source_required",
    quantityTarget: 1,
  ...
  },
  {
    ...
    name: "IndyMill 1.5 kW spindle and VFD upgrade",
    category: "Fabrication",
    description: "Optional 1.5 kW spindle, matched VFD, mount, collets, braking and filtering hardware, shielded cable, and upgraded extraction for a later guarded-machine revision.",
    inventoryClass: "fixed_equipment",
    availability: "unavailable",
    validationState: "validate_before_po",
    quantityTarget: 1,
    quantityUnit: "upgrade sets",
    tags: ["IndyMill", "1.5 kW spindle", "VFD", "optional upgrade", "guarded CNC"],
    validationNotes: ["Do not substitute this for the baseline spindle during the first build. Validate frame loads, mount geometry, electrical supply, VFD EMC, braking, earthing, runout, thermal behavior, extraction, and enclosure containment first.", "Require an updated risk assessment and machine commissioning record before enabling the higher-power spindle."]
  },
  {
    slug: "ego-oscar-stereo-camera",
    name: "Ego-OSCAR synchronized stereo camera",
    category: "Vision",
    description: "Dexcin USB stereo module with two global-shutter sensors, a single side-by-side UVC stream, and an exposure-strobe signal for the published Ego-OSCAR capture path.",
    inventoryClass: "serialized_asset",
    availability: "unavailable",
    validationState: "source_required",
    quantityTarget: 6,
    quantityUnit: "camera modules",
    tags: ["Ego-OSCAR", "global shutter", "hardware sync", "UVC", "42 mm baseline"],
    validationNotes: ["Confirm the exact Dexcin board and sensor revision supports two 1280 x 720 views at 30 FPS, a 126 degree field of view per sensor, one side-by-side MJPEG stream, and the exposed STRB signal before PO.", "Preserve the factory stereo geometry, add lens protection, and run a motion-and-frame-drop test before mounting the module on a person."]
  },
  {
    slug: "ego-oscar-radxa-capture-kit",
    name: "Ego-OSCAR Radxa ROCK 5C capture kit",
    category: "Edge compute",
    description: "Radxa ROCK 5C 2GB board, heatsink, right-angle USB adapter, cabling, and enclosure hardware for hardware-accelerated H.264 capture and local sensor logging.",
    inventoryClass: "serialized_asset",
    availability: "unavailable",
    validationState: "source_required",
    quantityTarget: 6,
    quantityUnit: "capture computers",
    tags: ["Ego-OSCAR", "Radxa ROCK 5C", "RK3588S", "H.264", "FFmpeg"],
    validationNotes: ["Validate the current ROCK 5C memory and storage support, Linux image, Rockchip MPP and FFmpeg path, USB bandwidth, GPIO mapping, and India sourcing against the upstream guide before PO.", "Require a 30-minute sustained recording test with no frame loss, thermal throttling, or corrupt output before field use."]
  },
  {
    slug: "ego-oscar-sync-controller-kit",
    name: "Ego-OSCAR sync and watchdog controller kit",
    category: "Controllers",
    description: "Seeed Studio XIAO ESP32-S3, ICM-20948 IMU, indicator LED, buzzer, button, prototyping board, connectors, and wiring for timestamped inertial capture and recording-health feedback.",
    inventoryClass: "reusable_tray",
    availability: "unavailable",
    validationState: "source_required",
    quantityTarget: 8,
    quantityUnit: "controller kits",
    tags: ["Ego-OSCAR", "XIAO ESP32-S3", "ICM-20948", "IMU", "watchdog"],
    validationNotes: ["The guide targets roughly 120 Hz six-axis IMU capture and a visible watchdog error when the host heartbeat is absent for more than two seconds; verify both with recorded timestamps.", "TDK marks ICM-20948 end-of-life. Qualify genuine stock or a revision-controlled substitute with new timing, axis, noise, and calibration evidence before standardizing the rig."]
  },
  {
    slug: "ego-oscar-power-storage-kit",
    name: "Ego-OSCAR field power and storage kit",
    category: "Power and safety",
    description: "High-endurance 256GB microSD storage, 10,000mAh USB-PD power bank, right-angle USB-C cable, strain relief, and protected charging accessories for one capture rig.",
    inventoryClass: "reusable_tray",
    availability: "unavailable",
    validationState: "source_required",
    quantityTarget: 8,
    quantityUnit: "field kits",
    tags: ["Ego-OSCAR", "256GB microSD", "USB-PD", "field power", "H.264"],
    validationNotes: ["The guide estimates roughly 12-14 GB per recorded hour and about 5-6 hours from a 10,000mAh power bank; measure the selected card and power bank under the complete workload.", "Use compliant cells and chargers, inspect cables and packs before issue, keep heat away from the wearer, and quarantine damaged or swollen packs."]
  },
  {
    slug: "ego-oscar-head-mount-kit",
    name: "Ego-OSCAR printed head-mount kit",
    category: "Fabrication",
    description: "Three published printed enclosure parts, sports visor or cap, inserts, fasteners, padding, lens protection, and cable retention for one head-worn assembly.",
    inventoryClass: "reusable_tray",
    availability: "unavailable",
    validationState: "source_required",
    quantityTarget: 8,
    quantityUnit: "mount kits",
    tags: ["Ego-OSCAR", "3D printing", "head mount", "enclosure", "wearable"],
    validationNotes: ["The reference assembly is approximately 280 g and is not moisture-resistant. Run fit, fastener-retention, thermal, field-of-view, and wearer-comfort checks before data collection.", "Use the published print files only after confirming their current reuse terms; document filament, print orientation, hardware, modifications, and assembly revision for every rig."]
  },
  {
    slug: "ego-oscar-calibration-kit",
    name: "Ego-OSCAR calibration and session-validation kit",
    category: "Vision",
    description: "Rigid 8 x 6 chessboard with 30 mm squares, Kalibr-compatible workstation setup, capture checklist, consent materials, and session-ingest tools for calibrated stereo-inertial recordings.",
    inventoryClass: "reusable_tray",
    availability: "unavailable",
    validationState: "source_required",
    quantityTarget: 2,
    quantityUnit: "shared calibration kits",
    tags: ["Ego-OSCAR", "Kalibr", "stereo calibration", "time sync", "data governance"],
    validationNotes: ["Calibrate each session and validate playable stereo H.264, roughly 120 Hz IMU data, exposure timestamps, calibration output, thermal state, and storage integrity before accepting the recording.", "Require informed consent and environment-owner permission, visible recording indication, bounded capture zones, face blurring where appropriate, encrypted ingest, access controls, and documented retention and deletion.", "The FPV Labs essay calls the release open source, while the repository README currently says no license has been granted. Treat code, firmware, CAD, and print files as reference-only until an explicit upstream license resolves that conflict."]
  },
  {
    slug: "muca-multitouch-controller",
    name: "MuCa mutual-capacitance controller",
    category: "Tactile sensing",
    description: "Open controller and breakout hardware for scanning unconventional mutual-capacitance electrode matrices and forwarding raw data or multitouch coordinates over I2C.",
    inventoryClass: "reusable_tray",
    availability: "unavailable",
    validationState: "source_required",
    quantityTarget: 6,
    quantityUnit: "controllers",
    tags: ["MuCa", "mutual capacitance", "I2C", "multitouch"],
    validationNotes: ["Validate the current MuCa hardware revision, firmware, electrode count, calibration status, host microcontroller, and India sourcing before PO.", "The upstream Arduino library notes that touch-point detection still needs calibration; begin with raw electrode capture."]
  },
  {
    slug: "artificial-skin-capacitive-kit",
    name: "Artificial-skin capacitive fabrication kit",
    category: "Tactile sensing",
    description: "Project-specific silicone elastomers, pigments, molds, conductive yarn or traces, adhesives, and fixtures for layered compliant capacitive skin prototypes.",
    inventoryClass: "consumable",
    availability: "unavailable",
    validationState: "source_required",
    quantityTarget: 6,
    quantityUnit: "prototype kits",
    tags: ["silicone", "conductive yarn", "electrode matrix", "artificial skin"],
    validationNotes: ["Reconcile materials and layer thicknesses with the selected Human-like Robot Skin or Skin-On fabrication guide before purchase.", "Approve SDSs, skin-contact handling, pigments, release agents, curing, ventilation, mold compatibility, and silicone-waste disposal before use."]
  },
  {
    slug: "polysense-controlled-chemistry-kit",
    name: "PolySense controlled chemistry kit",
    category: "Fabrication",
    description: "Dedicated project-specified reagents, textile substrates, sample containers, electrodes, and consumables for supervised in-situ polymerization trials.",
    inventoryClass: "consumable",
    availability: "unavailable",
    validationState: "source_required",
    quantityTarget: 6,
    quantityUnit: "experiment batches",
    tags: ["PolySense", "in-situ polymerization", "smart textiles", "piezoresistive"],
    validationNotes: ["Derive the exact current recipe from the PolySense paper and tutorial, then approve every reagent and substitute against current SDSs before purchase.", "Treat the source's kitchen-tool analogy as explanatory only: use no food-contact equipment, domestic drains, or unsupervised work."]
  },
  {
    slug: "supervised-wet-chemistry-station",
    name: "Supervised wet-chemistry safety station",
    category: "Power and safety",
    description: "A staff-controlled station for small materials experiments with ventilation, compatible PPE, secondary containment, spill response, labeled storage, and an approved waste stream.",
    inventoryClass: "fixed_equipment",
    availability: "unavailable",
    validationState: "source_required",
    quantityTarget: 1,
    quantityUnit: "controlled station",
    tags: ["wet chemistry", "ventilation", "PPE", "chemical waste"],
    validationNotes: ["A qualified EHS review must define ventilation, access, storage compatibility, spill response, exposure controls, waste handling, and emergency procedures before commissioning.", "Do not run PolySense chemistry on general maker benches or near food and drink."]
  },
  {
    slug: "eyecam-six-servo-mechanism",
    name: "Eyecam six-servo mechanism",
    category: "Motion",
    description: "Six matched micro servos, printed mechanism, shafts, fasteners, linkages, and cable routing for the published eyeball, eyelid, and eyebrow motion system.",
    inventoryClass: "reusable_tray",
    availability: "unavailable",
    validationState: "source_required",
    quantityTarget: 2,
    quantityUnit: "mechanism sets",
    tags: ["Eyecam", "6 servos", "eyelids", "expressive motion"],
    validationNotes: ["Use the upstream CAD and firmware to identify exact servo geometry, torque, travel, voltage, and horn compatibility before ordering.", "Commission travel limits at low torque and guard pinch points before attaching the cosmetic shell."]
  },
  {
    slug: "arduino-leonardo-pro-micro",
    name: "Arduino Leonardo Pro Micro-compatible controller",
    category: "Controllers",
    description: "ATmega32U4-class controller used by the published Eyecam firmware to coordinate six servo channels over USB.",
    inventoryClass: "reusable_tray",
    availability: "unavailable",
    validationState: "source_required",
    quantityTarget: 12,
    quantityUnit: "controllers",
    tags: ["ATmega32U4", "Pro Micro", "Arduino", "USB"],
    validationNotes: ["Confirm voltage, clock, pinout, USB bootloader, connector, and upstream firmware compatibility before bulk purchase.", "Power the servo rail separately with common ground and appropriate fuse/current limiting."]
  },
  {
    slug: "eyecam-pi-zero-camera-stack",
    name: "Eyecam Raspberry Pi Zero camera stack",
    category: "Vision",
    description: "Raspberry Pi Zero-class board, compatible camera, ribbon, storage, power, and USB gadget-mode setup for the published plug-and-play webcam path.",
    inventoryClass: "reusable_tray",
    availability: "unavailable",
    validationState: "source_required",
    quantityTarget: 2,
    quantityUnit: "camera stacks",
    tags: ["Raspberry Pi Zero", "Pi Camera", "USB webcam", "720p60"],
    validationNotes: ["Validate the current Pi Zero model, camera sensor, cable, USB gadget configuration, thermal behavior, and host compatibility against the archived build.", "Require visible recording indication, informed consent, local-only test footage, retention limits, and camera disablement outside supervised sessions."]
  },
  {
    slug: "eyecam-silicone-shell-kit",
    name: "Eyecam silicone shell and finishing kit",
    category: "Fabrication",
    description: "Optional sculpting, mold-making, silicone casting, pigment, adhesive, eyebrow, and eyelash materials for reproducing the project's anthropomorphic exterior.",
    inventoryClass: "consumable",
    availability: "unavailable",
    validationState: "source_required",
    quantityTarget: 2,
    quantityUnit: "shell kits",
    tags: ["Eyecam", "silicone casting", "mold making", "finishing"],
    validationNotes: ["Build and validate the mechanism and camera without cosmetic material first.", "Approve SDSs, ventilation, adhesives, pigments, curing, hygiene, and cleanup before supervised casting."]
  },
  {
    slug: "openmantaclaus-watertight-structure",
    name: "OpenMantaClaus watertight structure set",
    category: "Robot systems",
    description: "Pressure enclosure, dome, endcap, penetrators, relief valve, frame sheets, and mounting hardware for one AUV chassis.",
    inventoryClass: "serialized_asset",
    availability: "unavailable",
    validationState: "source_required",
    quantityTarget: 1,
    quantityUnit: "chassis set",
    tags: ["AUV", "watertight enclosure", "penetrators", "frame"],
    validationNotes: ["Reconcile the upstream BOM with the published CAD before ordering substitutes.", "Vacuum-test every sealed enclosure before powered pool work."]
  },
  {
    slug: "openmantaclaus-five-thruster-set",
    name: "OpenMantaClaus five-thruster propulsion set",
    category: "Motion",
    description: "Three vertical and two forward underwater thrusters, matched ESCs, mounts, propeller directions, cables, and penetrators.",
    inventoryClass: "serialized_asset",
    availability: "unavailable",
    validationState: "source_required",
    quantityTarget: 1,
    quantityUnit: "propulsion set",
    tags: ["AUV", "underwater thruster", "ESC", "5-thruster control"],
    validationNotes: ["Match each thruster, ESC, connector, cable, penetrator, voltage, and current rating before purchase.", "Commission direction and emergency-stop behavior in a guarded test before pool operation."]
  },
  {
    slug: "openmantaclaus-navigator-controller",
    name: "OpenMantaClaus Navigator flight controller",
    category: "Controllers",
    description: "Blue Robotics Navigator-class flight controller for the published BlueOS, ArduSub, and MAVROS control path.",
    inventoryClass: "serialized_asset",
    availability: "unavailable",
    validationState: "source_required",
    quantityTarget: 1,
    quantityUnit: "controller",
    tags: ["Navigator", "BlueOS", "ArduSub", "MAVROS"],
    validationNotes: ["Confirm the exact upstream-supported controller and BlueOS release before PO.", "The project documents BlueOS newer than 4.7 and a BLUEROV1 frame; revalidate both at build time."]
  },
  {
    slug: "openmantaclaus-pi4-8gb",
    name: "OpenMantaClaus Raspberry Pi 4B 8GB companion",
    category: "Edge compute",
    description: "Published companion computer for ROS 2 mission logic, quantized YOLO perception, task control, and EKF SLAM.",
    inventoryClass: "serialized_asset",
    availability: "unavailable",
    validationState: "source_required",
    quantityTarget: 1,
    quantityUnit: "computer set",
    tags: ["Raspberry Pi 4B", "ROS 2", "TFLite", "companion computer"],
    validationNotes: ["Include compatible storage, cooling, and a regulated 5V supply inside the electronics tray.", "The upstream build reports a 10-12 Hz inference constraint; test the complete load before pool trials."]
  },
  {
    slug: "openmantaclaus-camera-depth-set",
    name: "OpenMantaClaus camera and depth-sensing set",
    category: "Vision",
    description: "Monocular USB camera and Bar-class depth-pressure sensor for visual target tracking and underwater depth feedback.",
    inventoryClass: "serialized_asset",
    availability: "unavailable",
    validationState: "source_required",
    quantityTarget: 1,
    quantityUnit: "sensor set",
    tags: ["monocular camera", "depth sensor", "underwater vision", "YOLO"],
    validationNotes: ["Calibrate the camera in its final optical path and update the published intrinsics.", "Verify pressure range, cable penetrator, BlueOS support, and leak-test procedure before pool use."]
  },
  {
    slug: "openmantaclaus-power-estop",
    name: "OpenMantaClaus 4S power and E-stop set",
    category: "Power and safety",
    description: "Two 4S LiPo packs with regulated rails, power distribution, relay isolation, waterproof switching, and emergency stop hardware.",
    inventoryClass: "reusable_tray",
    availability: "unavailable",
    validationState: "source_required",
    quantityTarget: 1,
    quantityUnit: "power set",
    tags: ["4S LiPo", "E-stop", "power distribution", "underwater"],
    validationNotes: ["Engineer pack current, fusing, connectors, regulators, relay ratings, enclosure separation, and charging procedure as one system.", "Do not energize an untested or open enclosure near water."]
  },
  {
    slug: "openmantaclaus-bottom-vio-camera",
    name: "OpenMantaClaus bottom VIO camera",
    category: "Vision",
    description: "Optional OpenMV H7-class or equivalent bottom-facing camera for visual-inertial odometry and reduced dead-reckoning drift.",
    inventoryClass: "serialized_asset",
    availability: "unavailable",
    validationState: "source_required",
    quantityTarget: 1,
    quantityUnit: "camera",
    tags: ["OpenMV", "VIO", "bottom camera", "odometry"],
    validationNotes: ["This is an upstream-recommended extension, not part of the baseline autonomy path.", "Validate low-light pool performance, calibration, compute placement, and the odometry TF contract."]
  },
  {
    slug: "so101-pair",
...
export const projectComponentLinks: ProjectComponentLink[] = [
  ...
  ["eyecam", "eyecam-six-servo-mechanism", "required"],
  ["eyecam", "arduino-leonardo-pro-micro", "required"],
  ["eyecam", "eyecam-pi-zero-camera-stack", "required"],
  ["eyecam", "3d-printing-stock", "required"],
  ["eyecam", "electronics-bench", "required"],
  ["eyecam", "eyecam-silicone-shell-kit", "optional"],
  ["eyecam", "raspberry-pi-camera-v2", "alternative"],
  ["ego-oscar", "ego-oscar-stereo-camera", "required"],
  ["ego-oscar", "ego-oscar-radxa-capture-kit", "required"],
  ["ego-oscar", "ego-oscar-sync-controller-kit", "required"],
  ["ego-oscar", "ego-oscar-power-storage-kit", "required"],
  ["ego-oscar", "ego-oscar-head-mount-kit", "required"],
  ["ego-oscar", "ego-oscar-calibration-kit", "required"],
  ["ego-oscar", "electronics-bench", "required"],
  ["ego-oscar", "3d-printing-stock", "required"],
  ["ego-oscar", "bambu-lab-a1", "optional"],
  ["ego-oscar", "primary-nas", "optional"],
  ...
  ["diy-weather-station", "weather-pico-w-controller", "required"],
  ["diy-weather-station", "weather-environment-sensor-set", "required"],
  ["diy-weather-station", "weather-solar-power-stack", "required"],
  ["diy-weather-station", "weather-outdoor-enclosure-set", "required"],
  ["diy-weather-station", "weather-dashboard-server", "required"],
  ["diy-weather-station", "electronics-bench", "required"],
  ["diy-weather-station", "3d-printing-stock", "required"],
  ...
  ["openmantaclaus", "openmantaclaus-watertight-structure", "required"],
  ["openmantaclaus", "openmantaclaus-five-thruster-set", "required"],
  ["openmantaclaus", "openmantaclaus-navigator-controller", "required"],
  ["openmantaclaus", "openmantaclaus-pi4-8gb", "required"],
  ["openmantaclaus", "openmantaclaus-camera-depth-set", "required"],
  ["openmantaclaus", "openmantaclaus-power-estop", "required"],
  ["openmantaclaus", "battery-bms-safety", "required"],
  ["openmantaclaus", "hazard-zone-safety", "required"],
  ["openmantaclaus", "electronics-bench", "required"],
  ["openmantaclaus", "3d-printing-stock", "required"],
  ["openmantaclaus", "openmantaclaus-bottom-vio-camera", "optional"],
  ["openmantaclaus", "bambu-lab-p1s-combo", "optional"],
  ["openmantaclaus", "raspberry-pi-5", "alternative"],
  ["human-like-robot-skin", "muca-multitouch-controller", "required"],
  ["human-like-robot-skin", "artificial-skin-capacitive-kit", "required"],
  ["human-like-robot-skin", "electronics-bench", "required"],
  ["human-like-robot-skin", "force-torque-starter", "optional"],
  ["skin-on-interfaces", "muca-multitouch-controller", "required"],
  ...
  ["polysense", "polysense-controlled-chemistry-kit", "required"],
  ["polysense", "supervised-wet-chemistry-station", "required"],
  ["polysense", "electronics-bench", "required"],
  ["polysense", "wearable-sensor-kit", "optional"],
  ...
  ["indymill", "indymill-motion-structure-set", "required"],
  ["indymill", "indymill-grbl-motion-control-set", "required"],
  ["indymill", "indymill-500w-spindle-power-set", "required"],
  ["indymill", "indymill-machine-safety-set", "required"],
  ["indymill", "electronics-bench", "required"],
  ["indymill", "3d-printing-stock", "required"],
  ["indymill", "hazard-zone-safety", "required"],
  ["indymill", "indymill-1-5kw-spindle-upgrade", "optional"],
  ["indymill", "bambu-lab-a1", "optional"],
