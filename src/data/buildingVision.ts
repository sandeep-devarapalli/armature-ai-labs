...
export const buildingVisionItems: BuildingVisionItem[] = [
  {
    ...
    proposedUse: "Primary arrival, outdoor café seating and Armature identity",
    image: `${imageRoot}/00 - Exterior Building Frontage.png`,
    imageWidth: 1086,
    imageHeight: 1448,
    alt: "Cream-white Armature building frontage with updated identity, umbrella café seating, planters and a clear entrance route",
    ...
    keyElements: "Updated Armature identity, weighted café umbrellas, loose tables and chairs, and planted pots; remove visual clutter and cycles from this presentation view.",
  ...
  },
  {
    ...
    proposedUse: "Visitor welcome, check-in and a compact Armature goodies display",
    ...
    keyElements: "A movable reception desk, small merchandise display, visitor perch, warm task lighting and restrained Armature graphics.",
  ...
  },
  {
    ...
    proposedUse: "Access-controlled separation between the shared stair and Armature space",
