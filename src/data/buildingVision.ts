...
export const buildingVisionItems: BuildingVisionItem[] = [
  ...
  },
  {
    ...
    proposedUse: "FF02 lab room — R05 proposed steel-frame insulated-panel enclosure (C03)",
    ...
    modelNote: "R05 replaces the P01 glazed study with the C03 proposal: steel frame, PUF wall and roof panels, a polycarbonate skylight strip, three fixed windows and an insulated door to the retained balcony, with the lab layout inside. This is a saved concept model, not installed work; structure, weatherproofing, extraction and occupied access remain unresolved. The glass walls and glass roof in this earlier picture are not the current proposal.",
  ...
  },
  {
    ...
    proposedUse: "FF02 enclosure — superseded glass concept; see the R05 C03 proposal",
    ...
    modelNote: "This earlier lounge image shows a glass enclosure that is not the current proposal. R05 encloses the northern part of the terrace with an insulated-panel steel frame on the same line as the earlier study and keeps the curved balcony open. Use the current floor model and the FF02 enclosure CAD, not this picture, for furniture, door and roof positions.",
