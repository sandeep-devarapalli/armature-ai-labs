  ...
  return (
    <>
      ...
      <Section number="01" title="Google Calendar mirror">
        <div className="integration-banner"><CalendarSync aria-hidden="true" /><div><span className="mono">bookings@armatureailabs.com</span><h3>One private calendar per resource</h3><p>Supabase remains authoritative. Confirmed bookings enqueue idempotent create, update, and cancel operations; external edits are overwritten after conflict review.</p></div><Status tone={mode === "demo" ? "warn" : "good"}>{mode === "demo" ? "Not connected" : "Connected"}</Status></div>
