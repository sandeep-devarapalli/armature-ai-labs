...
export function BuildingPlanning() {
  ...
  return <Section number="01" id="planning-model" title="Models and room plans."
    ...
    <details className="building-release-details"><summary>Revision, sources and future updates</summary>
      <p>Model publication: R04, 12 September 2026. Only the FF03 four-person entrance changes to sliding; the updated first-floor model retains FF04/FF06 P03 entrances, FF02 workshop P01 and FF06 balcony B02. Ground-floor assets and 14 room extracts remain the published R03 files. Service quantities remain the unapproved S01 scenario of 10 September; the door revision does not recalculate them. Original CAD and Blender sources are preserved privately. Public current-design copies omit earlier trials and private computer-path metadata, with separate source and download hashes.</p>
