...
for (const pathname of ["/", "/services/", "/projects/", "/branding/", "/blog/", "/blog/model-hardware-standard/", "/projects/electrofluidic-fiber-muscles/", "/building-vision/", "/ecosystem/", "/components/", "/maker-desk/", "/join/"]) {
...
for (const filename of ["app-shell.html", "404.html", "members/index.html"]) {
  let dom;
  try {
    ...
    if (filename === "app-shell.html") {
      ...
      checkBody(document, filename === "404.html" ? "/not-found/" : "/members/");
    }
  } catch (error) {
