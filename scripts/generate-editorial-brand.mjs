...
await asset('logos/square-named-black-1024', 1024, 1024, background(1024, 1024, '#000000') + `<g transform="translate(0 128)">${mark(352, 80, 320, '#ffffff')}${lettering('wordmark', 512, 540, 96, '#ffffff', true)}${lettering('tagline', 512, 614, 21, '#ffffff', true)}</g>`, { kind: 'square-named', mode: 'dark', background: '#000000' });
await asset('logos/square-icon-black-1024', 1024, 1024, background(1024, 1024, '#000000') + mark(102.4, 102.4, 819.2, '#ffffff'), { kind: 'square-icon', mode: 'dark', background: '#000000' });
