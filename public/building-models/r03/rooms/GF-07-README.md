...
- Shared GF07/GF10 wall band includes its exact 6 in source end remainder. Booth door reduces the original opening; compact internal clearances remain.
...
Save/reopen: exact world-shape signatures matched for 58 extracted shapes. STEP readback passed validity, solid count, bounds, volume, area and summed-edge-length checks.
