# GF-09 — R02 room reference

Presentation lounge and stair access
...
- Includes Forward Shift01 furniture/AV and selected stair partition A01. Outward-door kitchen restriction, GF06 approach and reduced step-head clearance remain.
...
Save/reopen: exact world-shape signatures matched for 684 extracted shapes. STEP readback passed validity, solid count, bounds, volume, area and summed-edge-length checks.
