# FF-01 — R01 room reference

Rear small room reference
...
Save/reopen: exact world-shape signatures matched for 13 extracted shapes. STEP readback passed validity, solid count, bounds, volume, area and summed-edge-length checks.
