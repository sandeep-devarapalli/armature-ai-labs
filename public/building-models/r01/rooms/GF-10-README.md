...
- 9 T-01 tables, 17 counter chairs and 21 table chairs are selected model positions, not a certified 38-person simultaneous usable layout. Includes only the shared GF08 doorway from that adjacent-room fit-out.
...
Save/reopen: exact world-shape signatures matched for 187 extracted shapes. STEP readback passed validity, solid count, bounds, volume, area and summed-edge-length checks.
