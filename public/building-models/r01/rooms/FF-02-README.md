# FF-02 — R01 room reference

Exterior balcony / workshop brief
...
- Balcony R01 outline only; preliminary glass route is retained as hidden native paths. New workshop bench and new weatherproof cover are not implemented in this extract.
...
Save/reopen: exact world-shape signatures matched for 14 extracted shapes. STEP readback passed validity, solid count, bounds, volume, area and summed-edge-length checks.
