# GF-08 — R01 room reference

Enclosed balcony seating
...
- Includes P02 existing-door and curved-step approximation, 2 cafe tables, 4 chairs, bar and 2 stools. Frame/roof heights and installation details remain provisional.
...
Save/reopen: exact world-shape signatures matched for 339 extracted shapes. STEP readback passed validity, solid count, bounds, volume, area and summed-edge-length checks.
