...
- Every paid coworking/cabin pass, including day passes, includes unlimited pantry access during its valid workspace access: milk, juices, Maggi, eggs and similar essentials. Outside food orders are allowed; users must clean up and keep shared eating/pantry areas tidy. Free basic registration and event guest attendance alone do not grant these workspace perks.
